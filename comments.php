				...
				<div>
					<div class="element">
						...
						<div class="pf-body">
							...
							<!-- Rating Field -->
							<?php $rating_field = CASE27_Integrations_Review::get_ratings_field( false, get_the_ID() ); ?>

							<!-- Gallery Field -->
							<?php $gallery_field = CASE27_Integrations_Review::get_gallery_field( false, get_the_ID() ); ?>
							...
							$user_review = CASE27_Integrations_Review::has_user_reviewed( get_current_user_id(), get_the_ID() );
							...
							<div class="sidebar-comment-form">
								...
								if ( $user_review && is_singular('job_listing') ) : $hide_comment_form = true; ?>
									<form action="<?php echo esc_url( admin_url('admin-post.php') ); ?>" method="post" enctype="multipart/form-data">
										<?php echo CASE27_Integrations_Review::get_ratings_field( $user_review, get_the_ID() ); ?>
										<?php echo CASE27_Integrations_Review::get_gallery_field( $user_review, get_the_ID() ); ?>
										<div class="form-group">
											<label><?php _e( 'Your Message', 'my-listing' ) ?></label>
