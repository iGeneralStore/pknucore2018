...
class CASE27_Listings {
	...
	public function admin_fields($fields) {
		...
		$new_fields = [
			'_job_title' => isset( $new_fields['_job_title'] ) ? $new_fields['_job_title'] : null,
		...
		$new_fields['_job_title']['priority'] = 0.1;
		$new_fields['_case27_listing_type']['priority'] = 0.2;
		$new_fields['_job_description']['priority'] = 0.3;
